...
export default class HOS extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q2 = "Hoşunuza gitmeyen iletişimi şiddetli tartışma haline getirme sıklığınız";
        question_s.push(q2);

        let q3 = "Kontrol hakimiyetinizi kaybettiğiniz öfke patlamalarının sıklığı";
        question_s.push(q3);

        let q4 = "Hoşunuza gimeyen durumlarda başkalarını dövmek, onlara çeşitli şekillerde zarar vermek veya yaralamak gibi düşüncelerinizin oluşması sıklığı ve şiddeti";
        question_s.push(q4);

        let q5 = "Etrafınızdaki objeleri fırlatma veya kırma isteği yahut canlılara zarar verme isteği";
        question_s.push(q5);

        let q6 = "Tartışmaya girme sıklığınız";
        question_s.push(q6);

        let q7 = "Bağırma ya da eşyaları fırlatma arzusu";
        question_s.push(q7);
        ...
        return(
            <View>
                <Header style={{backgroundColor: 'white', borderBottomWidth: 2, borderBottomColor: '#f18a21'}}>
                    ...
                    <Text style={{marginTop: 16, fontSize: 20, fontFamily: "Helvetica-Bold"}}>HOS</Text>
