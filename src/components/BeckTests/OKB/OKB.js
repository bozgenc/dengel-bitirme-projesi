...
export default class OKB extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q2 = "Olayları hatırlarken zorlanmak";
        question_s.push(q2);

        let q3 = "Dikkatsizlik veya sakarlıkla ilgili düşüncelerin oluşma sıklığı";
        question_s.push(q3);

        let q4 = "İşlerin yapılmasını erteleme isteği";
        question_s.push(q4);

        let q5 = "Yapılan işlerin doğruluğundan emin olmak için olması gerekenden çok daha yavaş ve temkinli ilerleme durumu";
        question_s.push(q5);

        let q6 = "Yapılan işlerin bir ya da daha fazla kez kontrol edilmesinin zorunluluğu hissi";
        question_s.push(q6);

        let q7 = "Kararlar verirken güçlük çekmek";
        question_s.push(q7);

        let q8 = "Hiçbir şey düşünmeme durumu";
        question_s.push(q8);

        let q9 = "Zihninizi bir konuya yoğunlaştırırken zorlanmak";
        question_s.push(q9);

        let q10 = "Yıkanma, sayma, dokunma gibi bazı hareketleri yineleme hali";
        question_s.push(q10);
