...
export default class PAR extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q2 = "Başkalarına güvenilmemesi gerektiği düşüncesi";
        question_s.push(q2);

        let q3 = "Başkalarının sizi izlediği ve sizin hakkınızda konuştuğu hissi";
        question_s.push(q3);

        let q4 = "Başkaları tarafından kabul edilmeyen inançlarınızın ve düşüncelerinizin olması durumu";
        question_s.push(q4);

        let q5 = "Başarılarınızın yeterince takdir edilmediği hissi";
        question_s.push(q5);

        let q6 = "İnsanların sizi sömürmek istediği düşüncesi";
        question_s.push(q6);
        ...
        return(
            <View style = {styles.container}>
                <Header style={{backgroundColor: 'white', borderBottomWidth: 2, borderBottomColor: '#f18a21'}}>
                    ...
                    <Text style={{marginTop: 16, fontSize: 20, fontFamily: "Helvetica-Bold"}}>Paranoya</Text>
