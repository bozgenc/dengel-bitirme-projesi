...
export default class PSY extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q2 = "Kimsenin duymadığı sesleri duyma";
        question_s.push(q2);

        let q3 = "Başkalarının sizin özel düşünceslerinizi okuduğu hissi";
        question_s.push(q3);

        let q4 = "Aklınızdaki düşüncelerin başkasına ait olduğu hissi";
        question_s.push(q4);

        let q5 = "Başkalarıyla birlikte olduğun ortamlarda bile yalnız olduğunu düşünme";
        question_s.push(q5);

        let q6 = "Cinsiyet konusunda size rahatsızlık verici düşüncelerinizin olması";
        question_s.push(q6);

        let q7 = "İşlediğiniz günahlar dolayısıyla cezalandırılmanız gerektiği düşüncesi";
        question_s.push(q7);

        let q8 = "Bedeninizde ciddi bir poblem - rahatsızlık bulunduğu hissi";
        question_s.push(q8);

        let q9 = "Başkalarına yakınlık duymama durumu";
        question_s.push(q9);

        let q10 = "Düşünce sisteminizde bir problemin olduğu düşüncesi";
        question_s.push(q10);
