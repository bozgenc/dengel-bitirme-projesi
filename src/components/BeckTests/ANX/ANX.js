...
export default class ANX extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q1 = "Sinirlilik veya sinire bağlı içinin titremesi durumu";
        question_s.push(q1);

        let q2 = "Titremeler olması";
        question_s.push(q2);

        let q3 = "Sebepsiz yere ve aniden gelen korku hissi";
        question_s.push(q3);

        let q4 = "Korku hissetme durumu sıklığı";
        question_s.push(q4);

        let q5 = "Kalbinizin çok hızlı çarpması durumu";
        question_s.push(q5);

        let q6 = "Aşırı gerginlik veya aşırı coşku hissi";
        question_s.push(q6);

        let q7 = "Panik nöbetleri geçirme ve dehşet duyma";
        question_s.push(q7);

        let q8 = "Yerinizde duramayacak kadar rahatsızlık hissetme sıklığı";
        question_s.push(q8);

        let q9 = "Size veya sevdiklerinize kötü bir şey olacakmış hissinin sıklığı";
        question_s.push(q9);

        let q10 = "Hayallerinizin ve düşüncelerinizin sizi veya başkalarını korkutması sıklığı";
        question_s.push(q10);
    ...
    goNextQuestion = () => {
        ...
        if(newIndex==10){
            console.log("ANX (Kaygı) Score: ", this.state.score/10, "\n");
        ...
        return(
            <View style = {styles.container}>
                <Header style={{backgroundColor: 'white', borderBottomWidth: 2, borderBottomColor: '#f18a21'}}>
                    ...
                    <Text style={{marginTop: 16, fontSize: 20, fontFamily: "Helvetica-Bold"}}>Anksiyete</Text>
