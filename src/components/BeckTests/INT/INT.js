...
export default class INT extends Component{
    ...
    componentDidMount =  async () => {
        ...
        let q3 = "Duygularınızın kolayca incitilebilmesi durumu";
        question_s.push(q3);

        let q4 = "Başkalarının sizin durumunuzu anlamadığı veya hislerinizi hissedemeyeceği düşüncesi";
        question_s.push(q4);

        let q5 = "Başkalarının sizi sevmediği ya da dostça olmayan tavır ve tutumlar gösterdiği düşüncesi";
        question_s.push(q5);

        let q6 = "Kendinizi başkalarından daha düşük görme";
        question_s.push(q6);

        let q7 = "İnsanların size baktığı veya sizin hakkınızda konuştuğu zamanlarda rahatsız olma";
        question_s.push(q7);

        let q8 = "Başkalarının yanında fazlasıyla sıkılganlık hissetme";
        question_s.push(q8);

        let q9 = "Toplum içinde yemek yerken ya da bir şeyler içerken rahat hissedememe";
        question_s.push(q9);
